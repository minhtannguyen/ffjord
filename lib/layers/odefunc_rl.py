...
__all__ = ["ODEnet", "AutoencoderDiffEqNet", "ODEfunc_rl", "AutoencoderODEfunc"]
...
class ODEfunc_rl(nn.Module):
    ...
    def __init__(self, diffeq, divergence_fn="approximate", residual=False, rademacher=False):
        ...
        self.register_buffer("_num_evals_rl", torch.tensor(0.))
