...
class StackedCNFLayers(layers.SequentialFlow_Gate):
    def __init__(
        ...
        cnf_kwargs_hightol={"T": cnf_kwargs['T'], "train_T": cnf_kwargs['train_T'], "regularization_fns": cnf_kwargs['regularization_fns'], "solver": cnf_kwargs['solver'], "atol": cnf_kwargs['atol']*0.1, "rtol": cnf_kwargs['rtol']*0.1, "scale": cnf_kwargs['scale'], "gate": cnf_kwargs['gate']}
        if squeeze:
            c, h, w = initial_size
