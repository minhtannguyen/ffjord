...
def add_noise_concat(x):
    ...
    if args.add_noise:
        ...
        x_hl = tforms.functional.to_tensor(tforms.functional.affine(x_pil, angle=0., translate=(1,0), scale=1., shear=0.))
        x_hr = tforms.functional.to_tensor(tforms.functional.affine(x_pil, angle=0., translate=(-1,0), scale=1., shear=0.))
        x_vu = tforms.functional.to_tensor(tforms.functional.affine(x_pil, angle=0., translate=(0,1), scale=1., shear=0.))
        x_vd = tforms.functional.to_tensor(tforms.functional.affine(x_pil, angle=0., translate=(0,-1), scale=1., shear=0.))
        x = torch.cat((x, x_hl, x_hr, x_vu, x_vd),0)
